...
#define POS_RUN      (33.0f,  12.0f,   2.0f)//车移动时候位置

#define POS_OBSERVE  (184.0f, 100.0f,  2.0f)
#define POS_OBSERVE_RAW   (184.0f, 50.0f,  2.0f)//观察原料上的物料块位置
#define POS_OBSERVE_CIRCLE (184.0f, 100.0f,  2.0f)//观察圆环位置
#define POS_OBSERVE_TEMP  (184.0f, 40.0f,  2.0f)//观察暂存区上物料块位置

#define POS_RAW      (184.0f, 95.0f,  2.0f)//原料区抓取位置

#define POS_A        (3.0f,   35.0f,  2.0f)//车上放置位置
#define POS_B        (43.0f,  35.0f,  2.0f)
#define POS_C        (325.0f, 35.0f,  2.0f)

#define POS_1        (230.0f, 143.0f,  58.0f)//圆环
#define POS_2        (184.0f, 143.0f,  0.0f)
#define POS_3        (138.0f, 143.0f,  58.0f)
#define POS_1_HIGE   (230.0f, 83.0f,  58.0f)
#define POS_2_HIGE   (184.0f, 83.0f,  0.0f)
#define POS_3_HIGE   (138.0f, 83.0f,  58.0f)

void Pick_Test_Transfer(void);

/* 夹爪开合：Grab=抓住(0°)，Release=放开(90°) */
